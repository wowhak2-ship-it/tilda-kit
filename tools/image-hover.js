...
export default {
  ...
  insertHint: 'Вставь код в HEAD (действует на картинки галерей и блоков всего сайта). Для отдельных картинок Zero Block задай им CSS-класс и укажи его в «CSS-класс цели». Зум красивее всего в галереях — там Tilda сама обрезает края.',
  schema: [
    ...
    { key: 'targetClass', type: 'text', label: 'CSS-класс цели (опц.)', default: '', placeholder: 'например, my-img' },
  ],
  generate(v) {
